...
$tsence = optional_param('tsence', "", PARAM_TEXT); 
$ssence = optional_param('ssence', "", PARAM_TEXT); 
$psence = optional_param('psence', "", PARAM_TEXT); 
$isence = optional_param('isence', "", PARAM_TEXT); 
$esence = optional_param('esence', "", PARAM_TEXT); 

if ($tsence!="" || $ssence!="" || $psence!="" || $isence!="" || $esence!="") { $_SESSION["ModuloSence".$id] = "SI"; if ($esence!="" && $psence=="F") { $_SESSION["errorvisible".$id] = $esence; $_SESSION["swlogueado".$id] = $ssence; } else { if ($tsence=="I" && $psence=="E") { $_SESSION["swlogueado".$id] = "SI"; $_SESSION["IdSesionSence".$id] = $isence; } if ($tsence=="C" && $psence=="E") { $_SESSION["swlogueado".$id] = ""; $_SESSION["IdSesionSence".$id] = ""; } } redirect($CFG->wwwroot."/course/view.php?id=".$id); }
...
if ($_SESSION["ModuloSence".$id]=="SI") { echo html_writer::start_tag('div', array('class'=>'course-content', 'style'=>$_SESSION["ModuloSenceF".$id])); $_SESSION["ModuloSence".$id] = ""; } else { echo html_writer::start_tag('div', array('class'=>'course-content')); }
