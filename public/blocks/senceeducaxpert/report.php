...
foreach ($logs as $log) {
    ...
    // Bootstrap 5 (Moodle 4.0+/Boost): los atributos son data-bs-*, no data-*
    // (Bootstrap 4). Con data-toggle/data-target el botón no hacía nada.
    $btnjson = '<button type="button" class="btn btn-sm btn-dark" data-bs-toggle="modal" data-bs-target="#' . $modalid . '">
